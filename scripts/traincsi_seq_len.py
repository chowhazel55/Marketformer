...
def train(model, 
    ...
    for epoch in range(max_epochs):
        ...
        print_log("Epoch %d, train_loss %.6f, train_ic %.6f, train_icir %.6f, train_ric %.6f, train_ricir %.6f, train_mae %.6f, train_rmse %.6f, train_mape %.6f, train_acc %.6f, "
                    "valid_loss %.10f, valid_ic %.6f, valid_icir %.6f, valid_ric %.6f, valid_ricir %.6f, valid_mae %.6f, valid_rmse %.6f, valid_mape %.6f, valid_acc %.6f, "
...
if __name__=="__main__":
    ...
    parser.add_argument("-v", "--valid_period", type=int, default=2018)
    parser.add_argument("-t", "--test_period", type=int, default=2019)
    ...
    cfg = cfg[dataset]
    cfg["data_args"]["valid_year"]=args.valid_period
    cfg["data_args"]["test_year"]=args.test_period
    cfg["data_args"]["window"]=args.seq_len
